    ...
    <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600">Monitor system activity, errors, and security events</p>
          </div>
          ...
          {logLevels.map((level) => (
            <div
              ...
              className={`card cursor-pointer transition-all ${
                filterLevel === level.id ? 'ring-2 ring-blue-500' : 'hover:shadow-md'
              }`}
              ...
              <tbody className="divide-y divide-gray-200">
                {filteredLogs.map((log) => (
                  <tr key={log.id} className="hover:bg-gray-50">
                    ...
                    <td className="py-4 px-4 text-sm text-gray-900 font-mono">{log.timestamp}</td>
                    <td className="py-4 px-4">
                    ...
                    <td className="py-4 px-4 text-sm text-gray-900">{log.tenant}</td>
                    <td className="py-4 px-4 text-sm text-gray-900 font-mono">{log.ip}</td>
                  </tr>
                ))}
              </tbody>
            </table>
