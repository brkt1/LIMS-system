import { BarChart3, Building2, Calendar, Download, Filter, Search, Users } from 'lucide-react';
...
const AllTenants: React.FC = () => {
  ...
  const filteredTenants = tenants.filter(tenant => 
    filterStatus === 'all' || tenant.status.toLowerCase() === filterStatus.toLowerCase()
  );
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600">Complete overview of all tenant organizations</p>
          </div>
              ...
              <div key={tenant.id} className="card hover:shadow-lg transition-shadow">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                      <span className="text-lg font-bold text-blue-600">{tenant.logo}</span>
                    </div>
                    <div>
                ...
                <div className="space-y-3 mb-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium text-gray-900">{tenant.users}</span>
                  </div>
                  <div className="flex justify-between items-center">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium text-gray-900">${tenant.revenue.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-gray-600">Growth</span>
                    <span className={`font-medium ${getGrowthColor(tenant.growth)}`}>
                ...
                <tbody className="divide-y divide-gray-200">
                  {filteredTenants.map((tenant) => (
                    <tr key={tenant.id} className="hover:bg-gray-50">
                      <td className="py-4 px-4">
                        <div className="flex items-center space-x-3">
                          <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center">
                            <span className="text-sm font-bold text-blue-600">{tenant.logo}</span>
                          </div>
                          <div>
                      ...
                      <td className="py-4 px-4 text-sm text-gray-900">${tenant.revenue.toLocaleString()}</td>
                      <td className="py-4 px-4">
