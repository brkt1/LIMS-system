    ...
    <BaseDashboard>
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Global Notifications</h2>
            <p className="text-gray-600">Send notifications to all users and manage notification templates</p>
          </div>
          <button
          ...
          <div className="card">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{notificationStats.pending}</p>
              </div>
        ...
        {activeTab === 'compose' && (
          <div className="space-y-6">
            <div className="card">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Compose New Notification</h3>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-gray-200">
                      ...
                      <th className="text-left py-3 px-4 text-sm font-medium text-gray-500">Recipients</th>
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {recentNotifications.map((notification) => (
                      <tr key={notification.id} className="hover:bg-gray-50">
                        <td className="py-4 px-4 text-sm font-medium text-gray-900">{notification.subject}</td>
                        ...
                        <td className="py-4 px-4 text-sm text-gray-900">{notification.recipients.toLocaleString()}</td>
                        <td className="py-4 px-4 text-sm text-gray-900">{notification.sentAt}</td>
                        <td className="py-4 px-4 text-sm text-gray-900">{notification.openRate}%</td>
                        <td className="py-4 px-4">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Send critical notifications via SMS</p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
