...
class Technician(models.Model):
    ...
    user = models.OneToOneField('tenantaccess_login.User', on_delete=models.CASCADE, related_name='technician_profile')
...
class Sample(models.Model):
    ...
    tenant = models.ForeignKey(Tenant, on_delete=models.CASCADE, related_name='samples')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class TestResult(models.Model):
    ...
    tenant = models.ForeignKey(Tenant, on_delete=models.CASCADE, related_name='technician_test_results')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class QualityControl(models.Model):
    ...
    tenant = models.ForeignKey(Tenant, on_delete=models.CASCADE, related_name='quality_controls')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class LabWorkflow(models.Model):
    ...
    notes = models.TextField(blank=True, null=True)
    tenant = models.ForeignKey(Tenant, on_delete=models.CASCADE, related_name='lab_workflows')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
